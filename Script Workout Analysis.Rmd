...
```{r}
ggsave("Gráficos Progreso/Sentadilla.png", height = 4, width = 7)
```
...
```{r}
ggsave("Gráficos Progreso/Press banca.png", height = 4, width = 7)
```
...
```{r}
ggsave("Gráficos Progreso/Peso muerto.png", height = 4, width = 7)
```
...
```{r}
ggsave("Gráficos Progreso/Clean.png", height = 4, width = 7)
```
...
```{r}
ggsave("Gráficos Progreso/Remo.png", height = 4, width = 7)
```
